module github.com/zokypesch/proto-tools
...
require (
	...
	github.com/zokypesch/proto-lib v0.3.8
	go.elastic.co/apm/module/apmgrpc v1.8.0 // indirect
	go.elastic.co/apm/module/apmlogrus v1.8.0 // indirect
